<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="P2.UserBean"%>
<!DOCTYPE html>
<html>
<head>
...
out.print("Welcome User:"+ub.getFname());
%>
        <svg
            version="1.1"
            id="checkmark"
        ...
        <h3 id="status">Login Success</h3>
    </div>
    <div id="lower-side">
        <p id="message">
            Congratulations, your account has been successfully Login.
        </p>
        <a href="ViewProducts" id="contBtn">ViewAllProduct</a>
    </div>
</div>
</body>
</html>